                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">';
                                            $isSun="unchecked";$isMon="unchecked";$isTue="unchecked";$isWed="unchecked";$isThu="unchecked";$isFri="unchecked";$isSat="unchecked";
                                            $orderDay=str_split($key['order_day']);
                                            for ($k=0; $k < count($orderDay); $k++) { 
                                            	if($orderDay[$k]=='1'){$isSun="checked";}
                                            	elseif($orderDay[$k]=='2'){$isMon="checked";}
                                            	elseif($orderDay[$k]=='3'){$isTue="checked";}
                                            	elseif($orderDay[$k]=='4'){$isWed="checked";}
                                            	elseif($orderDay[$k]=='5'){$isThu="checked";}
                                            	elseif($orderDay[$k]=='6'){$isFri="checked";}
                                            	elseif($orderDay[$k]=='7'){$isSat="checked";}
                                            }
                                            $str=$str.'
                                                <div class="checkbox">
                                                    <label>
