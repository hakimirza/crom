...
<head>
    ...
    <title>Logitic Maintenance</title>
...
<body>
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a data-toggle="tab" href="#daftarProduk">LOGISTIK PER WILAYAH</a>
                                    </li>
                                    <li class="">
                                        <a data-toggle="tab" href="#preOrder">RASIO ORDER</a>
                                    </li>
                                </ul>
                            </header>
                                            ...
                                            <div class="panel-body">
                                                <div class="adv-table editable-table ">
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                                        ...
                                                        <tbody>
                                                        <?php include "data/dataLogistic.php" ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
    ...
    <script src="assets/js/table-log-editable.js"></script>
