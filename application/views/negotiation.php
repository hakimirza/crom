...
<head>
    ...
    <title>Negotiation Maintenance</title>
...
<body>
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a data-toggle="tab" href="#daftarProduk">DAFTAR NEGOSIASI</a>
                                    </li>
                                    <li class="">
                                        <a data-toggle="tab" href="#tambahProduk">TAMBAH NEGOSIASI</a>
                                    </li>
                                </ul>
                            </header>
                            <div class="panel-body">
                                <div class="tab-content">
                                            ...
                                            <div class="panel-body">
                                                <div class="adv-table editable-table ">
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                                        ...
                                                        <tbody>
                                                            <?php $this->load->view('data/dataNegosiasi') ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                             <!-- Modal -->
                                            <div class="modal fade" id="modalNego" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                            <h4 class="modal-title">Upload Rule Negosiasi</h4>
                                                        </div>
                                                        <div class="modal-body">

                                                            <section class="panel">
                                                                <div class="panel-body">
                                                                    <form id="uploadNego" method="post" action="upload.php" enctype="multipart/form-data">
                                                                        <div id="drop">
                                                                            Drop Here
                                    ...
                                    <div id="tambahProduk" class="tab-pane">
                                        <div class="well">
                                            Tambah data promosi produk dengan mengunggah file excel sesuai <b><a title="unduh file standar excel" href="#">format</a></b>
                                        </div>
                                        <section class="panel">
                                            <div class="panel-body">
    ...
    <script src="assets/js/table-nego-editable.js"></script>
