                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div id="approve_status" class="col-md-10 col-md-offset-1 alert alert-warning">
                                    ...
                                    <div id="no_data" class="col-md-10 col-md-offset-1 alert alert-warning">
                                        <strong>Warning!</strong> ID not found
                                    </div>
                                </div>
                            </div>
                        </section>
...
<script>
    $(document).ready(function() {
        dis();
        document.getElementById("approve_status").style.visibility = "hidden";
            ...
            $.ajax({
                ...
                success : function(hasil){
                    if(hasil==="1"){
                        ...
                        document.getElementById("approve_status").style.visibility = "visible";
                        document.getElementById("no_data").style.visibility = "hidden";
                    }else{
                        document.getElementById("approve_status").style.visibility = "hidden";
