...
<body>
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a data-toggle="tab" href="#daftarProduk">DAFTAR PROMO</a>
                                    </li>
                                    <li class="">
                                        <a data-toggle="tab" href="#tambahProduk">TAMBAH PROMO</a>
                                    </li>
                                </ul>
                            </header>
                                            ...
                                            <div class="panel-body">
                                                <div class="adv-table editable-table ">
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                                        ...
                                                        <tbody>
                                                            <?php $this->load->view('data/dataPromo') ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Upload Detail Promosi</h4>
                                                        </div>
    ...
    <script src="assets/js/table-promo-editable.js"></script>
